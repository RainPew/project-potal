...
import { getQuoteOrder } from "../../graphql/placeOrder";
import { getOrder } from "../../graphql/searchOrder";
import { EOrderStatus } from "../../types/EOrderStatus";
import QuoteOrderInput from "../../services/mockdata/QuoteOrderInput.json";
import QuoteOrderOutput from "../../services/mockdata/QuoteOrderOutput.json";
import { login } from "../../graphql/authentication";
import { GetJsonOrder } from "../../graphql/tracking";

const getDataGetOrder = ({
  orderNumber,
  orderStatus,
  dispatchDate = "5/13/2022 10:14:22 AM",
  dueDate = "5/18/2022 3:00:00 PM",
}: {
  orderNumber: string;
            ...
            JobStops: {
              JobStop: [
                ...
                },
                {
                  ...
                  "@Room": "Mail Room",
                  "@Note":
                    "See Green Tray, leave Pouch pick up any pkgs or bxs",
                  "@Latitude": "29.94884",
                  "@Longitude": "-95.34659",
                  "@LocationTypeID": "1",
                  "@CustomerShipToCode": "SC456",
        ...
        OrderEvents: {
          OrderEvent: [
            ...
            },
            {
              ...
              "@UserName": "test",
              "@Note":
                "JobDriverFee:1/0:DriverCommissionMultiplier:  --> 1.0000",
              "@EventSource": "",
              "@RefType": "JobDriverFee.JobDriverFeeID",
              "@RefItem": "JobDriverFee.DriverCommissionMultiplier",
            },
  ...
  return [
    ...
    },
    {
      request: {
        ...
        variables: {
          input: {
            OrderNumber: "no existed order number",
          },
        },
      },
      result: {
    ...
    },
    {
      ...
      result: {
        data: {
          GetQuoteOrder: QuoteOrderOutput,
          __typename: "GetQuoteOrder",
        },
      },
    },
    {
      ...
      result: {
        data: {
          login: {
            status: "0",
            UserGUID: "{D4850A47-50D6-4AFF-AC54-27198CA3C593}",
